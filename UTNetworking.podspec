...
Pod::Spec.new do |s|
  s.name             = 'UTNetworking'
  s.version          = '0.1.0'
  s.summary          = 'A short description of UTNetworking.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/UTNetworking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Santiago Lazzari' => 'santiaolazzariios@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/UTNetworking.git', :tag => s.version.to_s }
